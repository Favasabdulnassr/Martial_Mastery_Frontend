      ...
      <div className="flex-1 lg:ml-80">
        ...
        <div className="p-4 sm:p-6 space-y-4 sm:space-y-6">
          <div className="mb-4 sm:mb-6">
            ...
            <p className="text-sm sm:text-base text-gray-500 mt-1">Manage your martial arts students</p>
          </div>
                      ...
                      <div key={user.id || user.email} className="p-4 hover:bg-gray-50">
                        <div className="flex items-center space-x-3 mb-2">
                          <div className="h-8 w-8 rounded-lg bg-gray-900 flex items-center justify-center flex-shrink-0">
                            <span className="text-white text-xs">{user.first_name.split(' ').map(n => n[0]).join('')}</span>
                          </div>
                        ...
                        <div className="ml-11 space-y-1 text-sm">
                          ...
                          <div className="text-gray-600">
                            <span className="text-gray-500">Phone/Role: </span>{user.phone_number}, {user.role}
                          </div>
                        </div>
                      </div>
                    ))}
                ...
                <table className="w-full">
                  <thead>
                    <tr className="border-b border-gray-200">
                      ...
                      <th className="text-left p-4 font-medium text-gray-600">Phone/Role</th>
                    </tr>
                  </thead>
                  <tbody>
                    {loading ? (

        ...
        <div className="p-4 lg:p-8">
                  ...
                  <div className="flex justify-between items-start">
                    <div className="space-y-3">
                      ...
                      <div>
                        ...
                        <span className="text-green-700 text-sm font-medium bg-green-100 px-2.5 py-1 rounded-full mt-2 inline-block">
                          {stat.trend}
                        </span>
                      </div>
                    </div>
          ...
          <Card className="bg-white border border-gray-200 shadow-sm">
            ...
            <div className="p-4 lg:p-6">
              <div className="h-64 flex items-center justify-center text-gray-500 bg-gray-50 rounded-xl border border-gray-200">
                Content for {activeMenu} section goes here
              </div>
            </div>
          </Card>
        </div>
